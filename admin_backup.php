...
if (!isset($_GET['startrow']) or !is_numeric($_GET['startrow'])) {
  ...
  $startrow = (int)$_GET['startrow'];
        ...
        switch ($pager) {
          case 'home':
        // $r = "SELECT * FROM user WHERE sec='1'  AND reg_by='".$_SESSION['login_username']."' ORDER BY date DESC LIMIT $startrow, 30 ";
           ...
           $h="class='active'";
            ...
            case 'sec':
         //$q = "SELECT * FROM user WHERE sec='0' AND reg_by='".$_SESSION['login_username']."' ORDER BY date DESC LIMIT $startrow, 30 ";
...
<ul class="nav nav-tabs nav-justified" style=" width: 1px;">
  <li role="presentation" <?php echo $h ?> ><a style="color: #05147e;font-weight: bold; float: left"  href="<?php echo $_SERVER['PHP_SELF'].'?pager=home'?>">Trader</a></li>
  <li role="presentation" <?php  echo $s ?> ><a style="color: #05147e;font-weight: bold;float: left;" href="<?php echo $_SERVER['PHP_SELF'].'?pager=sec'?>">Finish</a></li>
  <li role="presentation" <?php echo $f ?> ><a style="color: #05147e;font-weight: bold; float: left"  href="<?php echo $_SERVER['PHP_SELF'].'?pager=ftd'?>">FTD</a></li>
   <li role="presentation" <?php echo $ca ?> ><a style="color: #05147e;font-weight: bold; float: left"  href="<?php echo $_SERVER['PHP_SELF'].'?pager=callback'?>">Callback</a></li>
    <li role="presentation" <?php echo $ni ?> ><a style="color: #05147e;font-weight: bold; float: left"  href="<?php echo $_SERVER['PHP_SELF'].'?pager=not_interested'?>">Not.Interested</a></li>
  <li role="presentation" <?php  echo $l ?> ><a style="color: #05147e;font-weight: bold;float: left;" href="<?php echo $_SERVER['PHP_SELF'].'?pager=op_leads'?>">Op.Leads</a></li>
   <li role="presentation"><a style="color: #05147e;font-weight: bold;float: left;" href="admin_meet.php">Meeting</a></li>
  <li role="presentation" <?php  echo $o ?> ><a style="color: #05147e;font-weight: bold;float: left;" href="<?php echo $_SERVER['PHP_SELF'].'?pager=operator'?>">Reg.Operators</a></li>
